...
def create_uzrh_fuel_BOL(lib):
    """
    Beginning-of-life fuel material based on TRIGA progression-problem
...
def main():
    ...
    out = {
        "case": "BOL",
        "description": "Beginning-of-life 2-group cross sections generated with corrected Sn postprocessor using TRIGA progression-problem materials.",
        "material_sources": {
    ...
    out_name = "project_2group_xs_BOL.json"
